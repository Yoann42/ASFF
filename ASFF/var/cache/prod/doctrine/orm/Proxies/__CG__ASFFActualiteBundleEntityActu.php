...
namespace Proxies\__CG__\ASFF\ActualiteBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Actu extends \ASFF\ActualiteBundle\Entity\Actu implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'ASFF\\ActualiteBundle\\Entity\\Actu' . "\0" . 'image', '' . "\0" . 'ASFF\\ActualiteBundle\\Entity\\Actu' . "\0" . 'id', '' . "\0" . 'ASFF\\ActualiteBundle\\Entity\\Actu' . "\0" . 'date', '' . "\0" . 'ASFF\\ActualiteBundle\\Entity\\Actu' . "\0" . 'titre', '' . "\0" . 'ASFF\\ActualiteBundle\\Entity\\Actu' . "\0" . 'auteur', '' . "\0" . 'ASFF\\ActualiteBundle\\Entity\\Actu' . "\0" . 'contenu', '' . "\0" . 'ASFF\\ActualiteBundle\\Entity\\Actu' . "\0" . 'publier', '' . "\0" . 'ASFF\\ActualiteBundle\\Entity\\Actu' . "\0" . 'urgent'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Actu $proxy) {
    ...
    public function setPublier($publier)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setPublier', [$publier]);

        return parent::setPublier($publier);
    }
    ...
    public function getPublier()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getPublier', []);

        return parent::getPublier();
    }
